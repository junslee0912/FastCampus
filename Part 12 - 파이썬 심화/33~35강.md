# Part 12. 파이썬 심화
### ch 33~35 (Object Reference - 01. Reference - 1,2,3)
...
tl1.append(1000)
tl1[1].remove(105)
# tl1과 tl2는 같은 id이므로 하나가 바뀌면 같이 바뀜.
print('EX4-5 -', tl1)
print('EX4-6 -', tl2)
print('EX4-7 -', tl3)
...
print('EX4-8 -', tl1)
print('EX4-9 -', tl2) # 튜플 재 할당(객체 새로 생성), 튜플은 원래 불변, 새로운 객체를 생성해 준 것임
print('EX4-10 -', tl3)
# print(id(tl1[2]))
# list안에 튜플을 넣는 것은 위험
print()
...
print('EX5-1 -', id(basket1), id(basket2), id(basket3)) # id 다 다름
print('EX5-2 -', id(basket1._products), id(basket2._products), id(basket3._products)) # 1과 2는 같음
print()
...
print('EX5-4 -', basket2._products) # basket1과 2는 같은 객체 참조 -> 하나가 바뀌면 다른 쪽에도 영향
...
print('EX7-3 -', tt4 is tt5, tt4 == tt5, id(tt4), id(tt5)) # true, true
print('EX7-4 -', ss1 is ss2, ss1 == ss2, id(ss1), id(ss2)) # true, true
```
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NzI4OTUyNDVdfQ==
-->